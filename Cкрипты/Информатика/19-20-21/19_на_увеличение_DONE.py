...
- добавить в кучу {first_add} камня;
- добавить в кучу {second_add} камней;
- увеличить количество камней в куче в {multiply} раза.
...
Игра завершается, когда количество камней в куче становится не менее {wins_count}. Победителем считается игрок, сделавший последний ход, то есть первым получивший кучу из {wins_count} или более камней. 
В начальной момент в куче было S камней, 1 < S < {wins_count - 1}.
